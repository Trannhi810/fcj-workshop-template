...
Hội thảo **FCAJ Community Day** (27/6/2026) được tổ chức với các mục tiêu chính:
...
- Diễn giả: Anh **Steve Trần** – Founder của Cloud Thinker *(Cựu Solution Architect tại AWS)*

**Session 2 – Giải pháp Giọng nói AI (Voice Agent) cho Doanh nghiệp**
- Diễn giả: Anh **Hiếu Nghị** *(Renova Cloud)*, Anh **Kiệt** *(AWS Study Group)* và Anh **Trung** – Founder & CEO *(R AI)*

**Session 3 – Trợ lý ảo DevOps (DevOps AI Agent) trên AWS**
- Diễn giả: Bạn **Nguyên Nguyễn** và Chị **Bảo** – Cloud Engineers đến từ *(Cloud Kinetic)*

**Session 4 – Trợ lý Tuyển dụng & Quản trị Nhân sự với Amazon Q**
- Diễn giả: Chị **Minh Anh** và Anh **Trường / Wynn** *(Noventic)*

**Session 5 – Thiết lập An toàn Bảo mật Kết nối Private cho Amazon Q qua MCP Server**
- Diễn giả: Anh **Hiếu Nghị** *(Renova Cloud)* và Bạn **Toàn Nguyễn** *(AWS Security Builder)*
...
*Diễn giả: Anh Hiếu Nghị (Renova Cloud) | Anh Kiệt (AWS Study Group) | Anh Trung – Founder & CEO (R AI)*
...
- **Minh họa thực tế:** Thử nghiệm Voice Agent xây dựng trên **AWS Bedrock** kết hợp **Knowledge Base** để tự động trả lời các thông tin chuyên sâu về thông số kỹ thuật sản phẩm — tuy nhiên phần demo gặp một số vấn đề kỹ thuật trong quá trình trình bày trực tiếp.

---

#### Session 3 – Trợ Lý Ảo DevOps (DevOps AI Agent) trên AWS

*Diễn giả: Bạn Nguyên Nguyễn | Chị Bảo – Cloud Kinetic*
...
*Diễn giả: Chị Minh Anh | Anh Trường / Wynn – Noventic*
...
*Diễn giả: Anh Hiếu Nghị (Renova Cloud) | Bạn Toàn Nguyễn (AWS Security Builder)*
...
- **Tìm hiểu Amazon Q và MCP:** Khám phá cách xây dựng knowledge base, cấu hình instruction cho AI Agent, và tích hợp với các dịch vụ nội bộ thông qua MCP Actions — áp dụng được cho nhiều bài toán tự động hóa thực tế.
