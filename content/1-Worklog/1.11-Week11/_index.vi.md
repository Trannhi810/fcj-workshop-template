...
| 5   | - Tích hợp gọi API từ Frontend lên API Gateway <br> - Truyền JWT Token của Cognito vào header (Authorization) để xác thực người dùng <br> - Kiểm thử luồng dữ liệu hoàn chỉnh từ UI -> API -> Lambda | 03/07/2026   | 04/07/2026      |                                           |
